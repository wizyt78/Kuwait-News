...
const T={
  ...
  ar:{
    ...
    p2:"يستفيد هذا المشروع المشترك من خوارزميات الذكاء الاصطناعي المتقدمة لمنصة "Quantum AI" التابعة لماسك، بهدف توفير دخل شهري مستدام لجميع المواطنين لمواجهة التضخم وارتفاع الأسعار.",
