...
const T={
  ...
  ar:{
    ...
    p2:"يستفيد هذا المشروع المشترك من خوارزميات الذكاء الاصطناعي المتقدمة التي تعتمد عليها منصة "Quantum AI" التابعة لإيلون ماسك، وذلك بهدف توفير دخل شهري مستدام لجميع المواطنين لمواجهة التضخم وارتفاع الأسعار. وقد حاول البنك المركزي الكويتي فرض تعتيم إعلامي شامل - شمل حظر المقابلة التلفزيونية التي شرح فيها ماسك تفاصيل المشروع - خشية حدوث عمليات سحب جماعي للأموال من الحسابات المصرفية التقليدية؛ إلا أنه، وعقب صدور توجيهات عليا، أُتيح للجمهور الوصول إلى النظام، وإن كان ذلك في نطاق محدود للغاية.",
